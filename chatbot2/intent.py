...
from chatbot2.command import (GreetCommand,
                    WishBackCommand,
                    DiseasePredictCommand,
                    AskSymptomBackCommand,
                    DiseasePredictFromSymptomCommand,
                    DoctorPredictIntentCommand,
                    DrugPredictIntentCommand)
                    # AddItemCommand,
                    # RemoveItemCommand,
                    # ShowItemsCommand,
                    # ClearListCommand,
...
class DiseasePredictIntent(Intent):

    def initCommands(self):
        val = self.commands.append(DiseasePredictCommand())
    ...
    def execute(self, data):
        ...
        s = s + self.commands[0].do(self.chatbot, data['text'])

        return s

class AskSymptomBackIntent(Intent):
    def initCommands(self):
        val = self.commands.append(AskSymptomBackCommand())
        # print("##########################################")
        # print(val)
        # print("##########################################")
        return val
...
class DiseasePredictFromSymptomIntent(Intent):

    def initCommands(self):
        val = self.commands.append(DiseasePredictFromSymptomCommand())
...
class DoctorPredictIntent(Intent):

    def initCommands(self):
        val = self.commands.append(DoctorPredictIntentCommand())
...
class DrugPredictIntent(Intent):

    def initCommands(self):
        val = self.commands.append(DrugPredictIntentCommand())
