...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="static/medbay/img/botAvatar.png"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
			$(BotResponse).appendTo('.chats').hide().fadeIn(1000);

		} else {
			//if we get response from Rasa
			var BotResponse = '<img class="botAvatar" src="static/medbay/img/botAvatar.png"><p class="botMsg">' + val + '</p><div class="clearfix"></div>';
			$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
